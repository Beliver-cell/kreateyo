...
export function EcommerceDigitalDashboard() {
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold mb-2">Digital Products Dashboard</h1>
        <p className="text-sm md:text-base text-muted-foreground">Manage your downloadable products and licenses</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        ...
        <Card className="p-4 md:p-6">
          <h2 className="text-lg md:text-xl font-semibold mb-4">Digital Product Tools</h2>
          <div className="grid grid-cols-1 gap-2 md:gap-3">
            <Button onClick={() => navigate('/digital-products')} className="w-full justify-start" variant="outline">
